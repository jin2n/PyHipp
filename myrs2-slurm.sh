...
DPT.objects.processDirs(dirs=['sessioneye/array02','session01/array0'], cmd='import PyHipp as pyh; import DataProcessingTools as DPT; DPT.objects.processDirs(None, pyh.RPLLFP, saveLevel=1); DPT.objects.processDirs(None, pyh.RPLHighPass, saveLevel=1);'); \
...
aws sns publish --topic-arn arn:aws:sns:ap-southeast-1:600728166650:awsnotify --message "RS2JobDone"
